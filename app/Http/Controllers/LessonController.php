...
class LessonController extends Controller
{
    function index(Request $request){
        ...
        $out = [
            "lessons" => GroupLessonResource::collection($lessons->skip($offset)->take($limit)),
            "count"   => $lessons->count()
        ];
    ...
    function show($id){
        return $this->response(GroupLessonResource::make(GroupLesson::find($id)));
    }
    ...
    function filters(){
        return [
            ...
            "price" => [
                GroupLesson::query()->min("price"),
                GroupLesson::query()->max("price"),
            ],
    ...
    function sign_up($id){
        $lesson = GroupLesson::find($id);
        if($lesson->students_max_count > $lesson->students->count()){
